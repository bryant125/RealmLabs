  ...
  integrations: [
    ...
    sitemap({
      ...
      customPages: [
        ...
        'https://www.realmlabs.app/mamabee/privacy',
        'https://www.realmlabs.app/mamabee/terms',
        ...
        'https://www.realmlabs.app/burnscroll/privacy',
        'https://www.realmlabs.app/burnscroll/terms',
      ],
    }),
  ],
});
