  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-[60] py-4 md:py-6">
      <div className="container mx-auto px-4 md:px-6">
        <div className="glass-card rounded-2xl px-4 md:px-8 py-3 md:py-4 flex items-center justify-between shadow-sm border-slate-200/60 relative bg-white/80 backdrop-blur-md">
