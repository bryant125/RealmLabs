...
(function () {
  ...
  var footerHTML = [
    ...
    '        <a class="soc" href="#" aria-label="MamaBee on X"><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M18.2 2H21l-6.5 7.4L22 22h-6.8l-4.7-6.2L4.9 22H2l7-8L2 2h7l4.2 5.7L18.2 2Zm-1.2 18h1.6L7.1 3.7H5.4L17 20Z"/></svg></a>',
    '        <a class="soc" href="#" aria-label="MamaBee on Instagram"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1.2" fill="currentColor" stroke="none"/></svg></a>',
    '        <a class="soc" href="#" aria-label="MamaBee on TikTok"><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M16.5 3c.3 2.1 1.6 3.7 3.5 4v2.7c-1.3 0-2.6-.4-3.6-1.1v5.9a5.6 5.6 0 1 1-5.6-5.6c.3 0 .6 0 .9.1v2.8a2.8 2.8 0 1 0 2 2.7V3h2.8Z"/></svg></a>',
    '      </div>',
